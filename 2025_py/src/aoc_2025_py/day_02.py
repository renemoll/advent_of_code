...
Part 1:
    The goal is to find the numbers which consist our of a sequence of numbers repeated twice.

    A simple solution is to treat each number as a string, split it in half and compare the two halves.

Part 2:
    For part 2 we have to find the number which have a sequence of numbers at least twice.

    I extended the solution from part 1.
"""
